    ...
    <>
      ...
      <div className="bg-slate w-full text-xl">
        <div className="mx-auto flex w-full max-w-[80rem] flex-col items-center justify-center px-1 md:flex-row xl:px-0">
          <div className="flex flex-col items-center justify-center gap-[1.75rem] pb-2 lg:flex-row lg:items-center lg:gap-0 pt-[1rem]">
            <div className="flex w-full max-w-[50rem] flex-col items-center justify-center gap-2 text-slate-100">
              <div className="text-cream">
                <h1 className="text-center text-[1.5rem] font-bold leading-6 text-cream sm:text-[3rem] lg:text-[3.5rem] lg:leading-[3.5rem]">
                  Resumo da live<br/>
                  <span
                ...
                <div className="mx-auto my-4 aspect-video w-full lg:max-w-[53.25rem]">
            <LiteYouTubeEmbed
              id="G_gBO94cfw4"
