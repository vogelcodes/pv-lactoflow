...
const CountdownReact = () => {
    ...
    return (<>
                    <div className="text-white w-[50%] flex flex-col items-center"> <div>A oferta acaba em:</div> <Countdown renderer={renderer} date={Date.parse('Nov 28 2023 02:59:59 GMT+0000')}/></div>
