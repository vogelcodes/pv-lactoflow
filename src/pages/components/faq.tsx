...
const faq = [
    ...
    ['É possível voltar a trabalhar e continuar amamentando?','Sim, e eu explico exatamente como conseguir no módulo 4 do curso.'],
    ...
    ['Tenho outras dúvidas, onde posso perguntar sobre elas?','Basta enviar um e-mail para xxx ou entrar em contato pelo whataspp número xxx que responderemos o mais rápido possível.']
]
