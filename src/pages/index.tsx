...
<section>
  ...
  <div className="flex flex-col items-center md:grid md:grid-cols-3 gap-2">
    {[1,2,3,4,5,6].map(number=>{
      return <Image className="rounded-xl" key={number} width={300} height={500} src={`/depoimentos/metodo/${number}.jpg`} alt="depoimento"/>
    })}
  </div>
</section>
                ...
                <span className="absolute top-3 right-5 text-blue font-extrabold cursor-pointer" onClick={closeModal}>✖</span>
                  ...
                  <div className="mt-2">
                    <form className="flex flex-col mb-8">
                      ...
                      <a target="_blank" href={`https://pay.hotmart.com/O84147403X?email=${email}&phoneac=${value?.toString().slice(3)}`}>
