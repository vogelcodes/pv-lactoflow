                ...
                <div className="flex min-h-full items-start justify-center bg-blue bg-opacity-70 p-4 text-center">
                  ...
                  >
                    <Dialog.Panel className="bg-white mt-16 w-full max-w-md transform overflow-hidden rounded-2xl bg-green p-6 text-left align-middle shadow-xl transition-all">
                      ...
                      <div className="mt-2">
                        <form className="mb-8  text-blue flex flex-col" action="https://lactoflow.us13.list-manage.com/subscribe/post?u=f2c713cb04fc024e126ae662d&amp;id=96c32b9825&amp;f_id=0034ede7f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form">
                          ...
                          className=""
                            ...
                            onChange={setValue}
                            />
                        <input type="submit" name="subscribe" id="mc-embedded-subscribe" className="drawer-button" value="Subscribe"></input>
                        </form>
                        <a
                          target="_blank"
